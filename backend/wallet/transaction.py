...
class Transaction:
    ...
    def to_json(self):
        """
        Deserialize the transaction's json back into a Transaction instance
        """
    ...
    def is_valid_transaction(transaction):
        ...
        Raise an exception for invalid
        """
    ...
    def reward_transaction(miner_wallet):
        """
        Generate a reward transaction for the miner
        """
        output = {}
...
def main():
    ...
    print(f"Restored: {restored_transaction}")
