...
class Wallet:
    ...
    def sign(self, data):
        """
        Generate a signature based on the data using hte local private key.
        """
    ...
    def calculate_balance(blockchain, address):
        ...
        The balance is found bya dding the output values that belong to the address since the most recent transaction by that address
        """
