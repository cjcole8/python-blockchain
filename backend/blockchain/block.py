...
class Block:
    ...
    def mine_block(last_block, data):
        ...
        Until a block hash is found that meets the leading 0's
    ...
    def adjust_difficulty(last_block, new_timestamp):
        """
        Calculate the adjusted difficulty according tot he MINE_RATE
        Increase/decrease the difficulty quickly
        """
    ...
    def is_valid_block(last_block, block):
        ...
        - meet proof of work requirement
